...
<head>
	...
	<script type="text/javascript" src="${contextPath}/resources/js/views/mng/config/midMenuGrp.js"></script>
	<script type="text/javascript" src="${contextPath}/resources/js/views/mng/config/lowMenu.js"></script>
