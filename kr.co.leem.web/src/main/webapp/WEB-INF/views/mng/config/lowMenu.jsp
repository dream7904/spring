			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div class="dataTable_wrapper">
						<table id="lowMenuGrid" class="table table-condensed table-hover table-striped">
							<thead>
							<tr>
								<th data-column-id="lowMenuSeq" data-type="numeric" data-identifier="true" data-align="center" data-header-align="center"
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-green">
				...
				<!-- /.panel-heading -->
				<div class="panel-body">
					<form role="form" id="lowMenuFrm" name="lowMenuFrm" method="post">
						...
						<input type="hidden" id="hdnMmgSeq" name="mmgSeq" value="${param.midMenuGrpSeq}">
						<input type="hidden" id="hdnTmgSeq" name="tmgSeq" value="${param.topMenuGrpSeq}">
						<input type="hidden" id="lowMenuSeq" name="lowMenuSeq" value="">
...
<script type="text/javascript">
	$(function () {
		lowMenuRest.contextPath = '${contextPath}';
		lowMenuRest.topMenuGrpSeq = ${param.topMenuGrpSeq};
		lowMenuRest.midMenuGrpSeq = ${param.midMenuGrpSeq};
		lowMenuRest.showLowMenuGrid();
		lowMenuRest.setEvents();
	});
</script>